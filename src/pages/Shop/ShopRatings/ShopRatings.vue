            ...
            <div class="content">
              ...
              <div class="recommend">
                <span
                  class="iconfont"
                  :class="
                    ratings.rateType === 0 ? 'icon-thumb_up' : 'icon-thumb_up'
                  "
                ></span>
                <span
                  class="item"
...
export default {
  data() {
    return {
      onlyShowText: false, //是否只显示有内容的评价
      selectType: 2
    }
  },
  ...
  computed: {
    ...
    filterRatings(){
      ...
      条件2：
        !onlyShowText || onlyShowText && rating.text.length > 0
      */
      return ratings.filter((rating)=>{
        const {rateType,text} = rating
       return (selectType === 2 || selectType === rateType) && (!onlyShowText || onlyShowText && rating.text.length > 0)
     })
    }
  },
